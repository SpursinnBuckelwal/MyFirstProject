...
CREATE TABLE RESREC (
 ...
 RESR_HPRIC          NUMBER(2,5),
 RESR_HSIZE          NUMBER(2,5),
 RESR_MGT            NUMBER(2,5),
 RESR_PUC            NUMBER(2,5),
 RESR_STR            NUMBER(2,5),
 RESR_WALL           NUMBER(2,5),
 RESR_LTG            NUMBER(2,5),
 RESR_VEN            NUMBER(2,5),
 RESR_TC             NUMBER(2,5),
 RESR_LC             NUMBER(2,5),
...
COMMIT;
UPDATE RESREC SET RESR_HPRIC=2.3,RESR_HSIZE=4.5,RESR_STR=2.62,RESR_LC=2.65 WHERE RESR_NO = 'RR171109-00043';
commit;