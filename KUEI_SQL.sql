...
INSERT INTO RESREC (RESR_NO, MEM_NO, HOUSE_NO, RTR_NO, RESR_STATES, RESR_DATE, RESR_PERIOD)VALUES ('RR'||TO_CHAR(SYSDATE,'RRMMDD')||'-'||(LPAD(to_char(RESR_SEQ.NEXTVAL),5,'0')),'MB00000002','HN00000001','RT00000009','ESTABLISH',TO_DATE('2017/10/30','YYYY/MM/DD'),'12:00-14:00');
INSERT INTO RESREC (RESR_NO, MEM_NO, HOUSE_NO, RTR_NO, RESR_STATES, RESR_DATE, RESR_PERIOD)VALUES ('RR'||TO_CHAR(SYSDATE,'RRMMDD')||'-'||(LPAD(to_char(RESR_SEQ.NEXTVAL),5,'0')),'MB00000001','HN00000002','RT00000010','ESTABLISH',TO_DATE('2017/10/29','YYYY/MM/DD'),'14:00-16:00');
...
UPDATE RESREC set RESR_STATES='CONFIRM',HSE_EVAL='{ "地段":"5", "屋齡":"3", "價格":"2" }',HSE_REV='價格有點小貴，屋齡尚可接受，結論:我覺得可以',MEM_RATE='4',MEM_REV='THIS REALTOR IS GOOD.',RTR_RATE='5' where RESR_NO = 'RR171028-00001';
UPDATE RESREC set RESR_STATES='CONFIRM',HSE_EVAL='{ "地段":"3", "屋齡":"2", "價格":"1" }',HSE_REV='超級雷，這什麼房子阿，沒想到房子也有照騙阿，超級失望又浪費時間',MEM_RATE='4',MEM_REV='雖然房子雷，但這房仲不錯，找房可以找他',RTR_RATE='5' where RESR_NO = 'RR171028-00004';
UPDATE RESREC set RESR_STATES='CANCEL' where RESR_NO = 'RR171028-00003';
COMMIT;
...
INSERT INTO HSECOLL VALUES('MB00000003','HN00000002');
INSERT INTO HSECOLL VALUES('MB00000004','HN00000005');
INSERT INTO HSECOLL VALUES('MB00000002','HN00000001');
INSERT INTO HSECOLL VALUES('MB00000002','HN00000002');
INSERT INTO HSECOLL VALUES('MB00000002','HN00000003');
INSERT INTO HSECOLL VALUES('MB00000002','HN00000005');
INSERT INTO HSECOLL VALUES('MB00000002','HN00000008');
INSERT INTO HSECOLL VALUES('MB00000001','HN00000006');
INSERT INTO HSECOLL VALUES('MB00000001','HN00000011');
INSERT INTO HSECOLL VALUES('MB00000001','HN00000001');
INSERT INTO HSECOLL VALUES('MB00000001','HN00000002');
COMMIT;
