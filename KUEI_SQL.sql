...
UPDATE RESREC set RESR_STATES='CONFIRM',HSE_EVAL='{ "地段":"5", "屋齡":"3", "價格":"2" }',HSE_REV='價格有點小貴，屋齡尚可接受，結論:我覺得可以',MEM_RATE='4',MEM_REV='THIS REALTOR IS GOOD.',RTR_RATE='5' where RESR_NO = 'RR171027-00001';
UPDATE RESREC set RESR_STATES='CONFIRM',HSE_EVAL='{ "地段":"3", "屋齡":"2", "價格":"1" }',HSE_REV='超級雷，這什麼房子阿，沒想到房子也有照騙阿，超級失望又浪費時間',MEM_RATE='4',MEM_REV='雖然房子雷，但這房仲不錯，找房可以找他',RTR_RATE='5' where RESR_NO = 'RR171027-00004';
UPDATE RESREC set RESR_STATES='CANCEL' where RESR_NO = 'RR171027-00003';
COMMIT;
...
INSERT INTO HSECOLL VALUES('HN00000005','MB00000004');
